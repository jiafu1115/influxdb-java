...
public enum TimeUtil {
	...
	private final static EnumSet<TimeUnit> ALLOWED_TIME_UNITS = EnumSet.of(
			TimeUnit.HOURS,
			TimeUnit.MINUTES,
			TimeUnit.SECONDS,
	...
	public static String toTimePrecision(final TimeUnit t) {
		...
		case NANOSECONDS:
			return "n";
		default:
			throw new IllegalArgumentException("time precision must be one of:" + ALLOWED_TIME_UNITS);
		}
	}
